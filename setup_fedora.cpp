...
int main(){
    ...
    char check_nvidia_drivers[] = "sudo dnf module list nvidia-driver";
    ...
    printf("Please check it is install successfully :D\n");
    ...
    system(check_nvidia_drivers);
    printf("If it is install successfully it sould print some drivers\n");
    printf("Please check it is install successfully :D\n");
    printf("Press any key to continue...");
    fgetc(stdin);
    fgetc(stdin);
